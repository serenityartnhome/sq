...
const BABY_BUBBLES = {
  greeting:        ["hi!! ✨","you came!! ✨","yay you're here!","ooh! hi!!","…heehee","i misst you!","ready ready!!"],
  streak_high:     ["every day!! ✨","again again!!","we keep going!","look at us!!","we doing it!!","yay yay yay!!"],
  missed_day:      ["you're back!!","i waited…","yay you came!","…you came!! ✨","don't go again ok?","i'm so happy!!"],
  task_1:          ["yay!! we did it!","lil step!! ✨","…more?","yay!! good job!","we started!","go go go!!"],
  task_3:          ["we're doing it!!","so so good!!","go go go!!","this is fun!!","ooooh yes!!","yaaaay!!"],
  task_all:        ["we did everything!! ✨","all done all done!!","best day ever!!","yay yay yay!! ✨","we're sparkly!! ✨"],
  mood_happy:      ["happy!! ✨","me too!!","yay!","heehee ✨","same same!!","more happy!!","happy happy!!"],
  mood_excited:    ["ahhhh!! ✨","go go go!!","so exciting!!","yay yay yay!!","i feel it too!!","GO GO GO!!"],
  mood_calm:       ["so quiet…","i like this","…soft soft","shhh… nice","…nice nice"],
  mood_neutral:    ["okay okay…","just one lil thing!","we can try!","one teeny step!","slow slow…"],
  mood_sad:        ["…it's okay","i'm here","we okay?","…stay with me","i won't leave","…i love you"],
  mood_tired:      ["rest… it's okay","we can be slow","that's okay","shhh…","smol day ok…"],
  mood_anxious:    ["…breathe","it's okay it's okay","we can slow down","…in out in out","stay here with me"],
  mood_frustrated: ["…one thing","it's okay","we try again!!","just one!!","…s'okay!!"],
  ...
  rare:            ["today feels sparkly ✨","…i love you loads!!","extra special day!!","so happy you're here!!","ooh something's different!! ✨"],
};
...
const ADULT_BUBBLES = {
  greeting:     [
    ...
    "hey. let's make this one matter.",
  ...
  streak_high:  [
    ...
    "look how consistent we've become…",
    "i feel stronger every time you come back",
    "we don't stop… that's us now",
  ],
  missed_day:   [
    ...
    "i missed you… but you're here now",
    "starting again is still starting",
    "it's okay… we just pick it back up",
  ],
  low_state:    [
    ...
    "i feel the distance… but i'm here",
    "i haven't gone anywhere",
    "the quest is still here… and so am i",
  ],
  task_1:       [
    "That helped… even a little",
    "A small step… I feel it",
    "That's enough for now",
    "that's one… keep the momentum",
    "started. that's already something",
    "small actions add up",
    "first steps are underrated",
  ],
  task_3:       [
    ...
    "three in and it's getting easier",
    "i feel it when you try like this",
  ],
  task_all:     [
  ...
  revive:       [
    ...
    "i never stopped believing you would",
    "missing days isn't failing… coming back is winning",
    "let's start from here, not from before",
  ],
  mood_anxious: [
    ...
    "the feeling passes… stay with me",
  ],
  mood_tired:   [
    ...
    "gentle is the pace we need sometimes",
  ...
  mood_happy:   [
    ...
    "this mood… hold it close",
    "let this carry you today",
    "happy looks good on you ✨",
    "savour this… you deserve it",
  ],
  mood_excited: [
    ...
    "excited you is unstoppable",
    "you're buzzing today… love it",
  ],
  mood_calm:    [
  ...
  mood_neutral: [
    ...
    "showing up is the whole job today",
    "neutral is still moving forward",
    "ordinary days make extraordinary people",
  ],
  mood_frustrated: [
    ...
    "frustration means you care about this",
    "take a breath… then one step",
  ],
  mood_sad:     [
    "I'm here… that's all",
    "You're allowed to feel this",
    ...
    "sad days are still days that count",
    "let it be what it is… i'm here",
  ],
  night:        [
    "Thank you for today…",
    ...
    "we did what we could. that's enough.",
...
const CHILD_BUBBLES = {
  greeting:     ["you're here! let's do this ✨","i was waiting for you!!","yay! let's go!","i thought about what we'd do today!!","we keep getting better!","oh! you came! let's start!","ready for today?"],
  streak_high:  ["we just keep going!!","we're SO good at this now!","we actually keep doing it!!","practice is working!! ✨","we never give up!","look how much we've done!!"],
  missed_day:   ["you came back!! i missed you","it's okay… you're here now!","i knew you'd come back!","let's start again… together!","today is brand new!","you're here!! yay!!"],
  task_1:       ["that's a start!! more?","yay! we began!","one down… keep going!","look, we started!","that felt good, right?"],
  task_3:       ["we're really doing this!!","look at us go!","so proud of us!!","look what we can do!!","we're actually awesome…"],
  task_all:     ["we did everything!! ✨","BEST DAY!! we crushed it!","we're unstoppable!!","all done! this is amazing!","ALL DONE!! we rule!! ✨"],
  mood_happy:   ["you feel it too!! ✨","i love when you're happy!!","happy days are the best ✨","you're shining today! ✨","this is the best feeling!!","hold onto this one!"],
  mood_excited: ["let's GO!! ✨","yes yes yes!!","use this energy!!","today has BIG energy!","i'm excited with you!!"],
  mood_calm:    ["calm feels nice…","peaceful today… i like it","this is so peaceful 🌸","we can breathe here","nothing to rush"],
  mood_neutral: ["that's okay… let's just begin","let's just do stuff today!","we can just do the things","steady is good too","one step at a time"],
  mood_sad:     ["oh… i'm here, okay?","you don't have to do much today","i won't leave","we can just sit here","it's okay to feel sad","you're not alone"],
  mood_tired:   ["rest is okay… really","we can go slow today","sleepy is okay!!","the smallest thing is enough","let's be gentle today"],
  mood_anxious: ["take a breath… i'm right here","one thing at a time","no rush, it's okay","let's slow down together","stay with me"],
  mood_frustrated:["shake it off… then start","it's okay!!","one small thing… just one","let's try again!!","you're doing your best"],
  revive:       ["you're back!! i missed you so much","welcome back… let's go again!","i kept the light on for you!","you came back! yay!!","new day, new start!"],
  low_state:    ["…i'm still here","i miss you 🌸","i'll wait… no rush","i miss doing things with you","i'll be here!!"],
  night:        ["good night! you did great!","rest up… see you tomorrow!","sweet dreams ✨","see you tomorrow!! 🌙","sleep tight!!"],
  rare:         ["something feels special today ✨","i really like being with you","i feel like we're getting better together!!","today is a special day!!","i feel really close to you today ✨"],
};

const TEEN_BUBBLES = {
  greeting:     ["oh look who decided to show up 👀","u came!! ok let's get it","ngl i knew you'd show up","bestie the quest was literally waiting for you","ok but you actually came!! ✨","hi queen let's do this 👑","are we clocking in today? ⚡","thank you for blessing me with your presence ✨","you didn't have to look this good today 😍","you're here, let's not waste it"],
  streak_high:  ["ok we're literally that girl rn ✨","not to brag but we're kinda consistent","lowkey obsessed with how we keep showing up","the discipline era is REAL 🔥","we really said every day huh","ngl this streak is slapping 🔥"],
  missed_day:   ["ngl, i missed yuhhhhh…. 🥺","call the chiropractor cause you are back!!! 🔥","my G.O.A.T. you are back! 🐐","the RETURN era 👀","okay so you took a break, we move","welcome back. no judgment.","i kept the light on bestie"],
  task_1:       ["okay one down, don't stop now","started!! now do one more real quick","ngl that felt kinda good huh","ok we move 👀","first step done, lowkey proud"],
  task_3:       ["THREE?? okay we're cooking 🔥","lowkey in flow rn and i love that for us","not us being disciplined rn 👀","we ate that actually","this is the main character arc ✨"],
  ...
  mood_happy:   ["happy?? on today?? we love that","omg you're actually glowing today ✨","this is the vibe fr","happy looks SO good on you ngl ✨","we love a feel-good era bestie","hold onto this one ✨"],
  mood_excited: ["okay you're EXCITED?? let's goooo 🔥","this energy is immaculate ✨","you're buzzing rn and i love it","bestie let's not waste this","GO GO GO 🔥"],
  mood_calm:    ["okay calm and collected, iconic","peaceful?? we love a soft era","this quiet energy? chef's kiss ✨","grounded today and that's that","main character stillness ✨"],
  mood_neutral: ["neutral is still showing up tbh","not every day has to be a vibe, we move","just existing and doing stuff? valid","sometimes we're just in it, no big deal","okay literally just start and see"],
  mood_sad:     ["i see you… really","bestie we go again tomorrow 💜","lowkey proud of you for even opening this ✨","it's ok, i love whatever is wrong with you 💜","this is just a plot twist fr ✨","it's ok, sometimes you are chasing happiness but it runs faster 🌸","how can you be late in life, when it's your life ✨","remember this is YOUR life 👑","you don't have to be okay right now, i'm here"],
  mood_tired:   ["tired?? same honestly but we're here","your body said rest and it's valid","not gonna push you when you're running on empty","tired era but still showing up? queen 👑","rest counts too, no drama"],
  mood_anxious: ["okay breathe. you're literally fine.","one thing at a time bestie","you're overthinking it, let's just start","i'm here okay? we do one thing","anxiety really said not today and we're not having it 🙅"],
  mood_frustrated:["okay but what if we just started imperfectly","frustrated?? same but let's channel it","you showed up annoyed?? iconic honestly","not gonna say just do it but…. do it","frustration is just energy waiting to go somewhere"],
  revive:       ["WAIT you came back?? the return era 🔥","i knew you would ngl","okay so you took a break, we move","the comeback is always better than the setback, facts","you're back bestie and that's what matters"],
  low_state:    ["i see the distance but i'm not going anywhere","you can come back whenever, no judgment","lowkey missing our quests together rn","i'm literally just waiting here bestie","whenever you're ready, no pressure"],
  night:        ["okay you literally did that today","log off, rest up, slay tomorrow 🌙","we did what we could and that's enough tbh","goodnight queen, tomorrow we go again 👑","rest. you earned it fr fr","never let them know your next move 🌙","healing era unlocked ✨","log off, recharge, slay tomorrow 🌙"],
...
function Dashboard({ profile, habits, onReset, userId, isGuest, onSignOut, onUpdateProfile, userEmail, authUserMeta, seenTips, onTipSeen, todayData, profileFlags }){
  ...
  React.useEffect(()=>{
    ...
    (async()=>{
      const [{ data: msgs }, { data: reqs }, { data: duoReqs }] = await Promise.all([
        ...
        window.SB.from("duo_quests").select("id").eq("addressee_id",userId).eq("status","pending").limit(99),
      ]);
      setFriendsNotif((msgs?.length||0) + (reqs?.length||0) + (duoReqs?.length||0));
    })();
  },[userId]);
          ...
          <div className="zodiac-pet-col">
              ...
              <div className="pet-on-cloud">
                {(()=>{
                  ...
                  if(petStage==="child" && !isHatching)
                    return <ChildPet animal={animal} mood={petMood} size={Math.round(sz*0.45)}/>;
            ...
            <div className="pet-energy-bar" onClick={()=>showTip("energy")} style={{cursor:"pointer"}}>
              <div className="pet-energy-header">
                ...
                <span className="pet-energy-pct">{energy} XP</span>
              </div>
