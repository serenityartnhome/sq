...
const TEEN_BUBBLES = {
  greeting:     ["oh look who decided to show up 👀","u came!! ok let's get it","ngl i knew you'd show up","bestie the quest was literally waiting for you","ok but you actually came!! ✨","hi legend let's do this 👑","are we clocking in today? ⚡","thank you for blessing me with your presence ✨","you didn't have to look this good today 😍","you're here, let's not waste it"],
  streak_high:  ["ok we're literally IT rn ✨","not to brag but we're kinda consistent","lowkey obsessed with how we keep showing up","the discipline era is REAL 🔥","we really said every day huh","ngl this streak is slapping 🔥"],
  ...
  mood_tired:   ["tired?? same honestly but we're here","your body said rest and it's valid","not gonna push you when you're running on empty","tired era but still showing up? legend 👑","rest counts too, no drama"],
  ...
  night:        ["okay you literally did that today","log off, rest up, slay tomorrow 🌙","we did what we could and that's enough tbh","goodnight legend, tomorrow we go again 👑","rest. you earned it fr fr","never let them know your next move 🌙","healing era unlocked ✨","log off, recharge, slay tomorrow 🌙"],
