      ...
      <div style={{display:"flex",justifyContent:"center",marginTop:24,padding:"0 16px"}}>
        <div className="panel" style={{maxWidth:420,width:"100%"}}>
          ...
          {mode !== "forgot" && <>
            ...
            <button onClick={()=>SB.auth.signInWithGoogle()} className="btn-primary"
              style={{width:"100%",background:"var(--rose)"}}>
              <Icon name="sparkle" size={16}/> Continue with Google <Icon name="sparkle" size={16}/>
            </button>
          </>}
